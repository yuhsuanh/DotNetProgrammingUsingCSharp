...
namespace UsedVehicleSystem.Controllers
{
    public class VehicleTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VehicleTypeId,Name,CreateDate,EditDate")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VehicleTypeId,Name,CreateDate,EditDate")] VehicleType vehicleType)
        {
            if (ModelState.IsValid)
            {
                vehicleType.EditDate = DateTime.Now;
